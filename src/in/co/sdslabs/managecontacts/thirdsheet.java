...
public class thirdsheet extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		database1 db = new database1(thirdsheet.this);
		db.open();
		boolean val = db.checkEmptyTable3();
		if (val == true) {
			Toast.makeText(getApplicationContext(),
					"Table Empty..So Shifting to UpDate Column..",
					Toast.LENGTH_LONG).show();
			Intent i = new Intent(thirdsheet.this, thirdbackhand.class);
			startActivity(i);
		}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.homepage: {
			Intent i = new Intent(thirdsheet.this, Homepage.class);
			startActivity(i);
			break;
		}
		case R.id.settings: {
		...
		case R.id.masssms: {
			Intent i = new Intent(thirdsheet.this, massmessage3.class);
			startActivity(i);
			break;
		}
		case R.id.contactimport: {
			AlertDialog.Builder alrt = new AlertDialog.Builder(thirdsheet.this);
			...
			alrt.setPositiveButton("Import",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface arg0, int arg1) {
							// TODO Auto-generated method stub
							Intent i = new Intent(thirdsheet.this, add3.class);
							startActivity(i);
						}
					});
			alrt.setNegativeButton("Cancel",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface arg0, int arg1) {
							// TODO Auto-generated method stub
							Intent i = new Intent(thirdsheet.this,
									thirdsheet.class);
							startActivity(i);
						}
					});
	...
	private void prepareListData() {
		...
		String[] branch = db.getBranch3();
		String[] year = db.getYear3();
		String[] email = db.getEmail3();
		String[] mobilenumber = db.getContact3();
		String[] dob = db.getDOB3();
		int i = 0;
		while (i < p) {
