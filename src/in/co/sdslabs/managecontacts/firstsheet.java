...
public class firstsheet extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		db.open();
		boolean val = db.checkEmptyTable1();
		if (val == true) {
			Toast.makeText(getApplicationContext(),
					"Table Empty..So Shifting to UpDate Column..",
					Toast.LENGTH_LONG).show();
			Intent i = new Intent(firstsheet.this, firstbackhand.class);
			startActivity(i);
		}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.homepage: {
			Intent i = new Intent(firstsheet.this, Homepage.class);
			startActivity(i);
			break;
		}
		case R.id.settings: {
		...
		case R.id.masssms: {
			Intent i = new Intent(firstsheet.this, massmessage.class);
			startActivity(i);
			break;
		}
			...
			alrt.setPositiveButton("Import",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface arg0, int arg1) {
							// TODO Auto-generated method stub
							Intent i = new Intent(firstsheet.this, add.class);
							startActivity(i);
						}
					});
		...
		case R.id.notifie:{
			AlertDialog.Builder alrt = new AlertDialog.Builder(firstsheet.this);
			alrt.setTitle("Notification::");
			alrt.setMessage("Do you want to set birthday notifications on??");
			alrt.setPositiveButton("Yes",
					new DialogInterface.OnClickListener() {

						@Override
						public void onClick(DialogInterface arg0, int arg1) {
							// TODO Auto-generated method stub
							Intent i = new Intent(firstsheet.this, notification.class);
							startActivity(i);
						}
					});
			alrt.setNegativeButton("No",
					new DialogInterface.OnClickListener() {
